...
//../../artifacts/contracts/coffee.sol/coffe.json
    ...
    try {
      ...
      if (ethereum) {
        ...
        const coffeeTxn = await buyMeACoffee.BuyACoffee(
          name ? name : "anon",
          message ? message : "Enjoy your coffeee!",
  ...
  return (
    <div className={styles.container}>
        ...
        {currentAccount ? (
          <div>
            <form>
              ...
              <div class="formgroup">
                <label>
                  Send Shreshth a message as a wish
                </label>
                <br/>
      ...
      <footer className={styles.footer}>
        <a>
          Created by @Shreshth for Alchemy's Road to Web3 lesson two learning purposes!
        </a>
      </footer>
    </div>
  )
